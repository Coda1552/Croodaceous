...
public class CEEntities {
    ...
    public static final RegistryObject<EntityType<Bearowl>> BEAROWL = ENTITIES.register("bearowl", () -> EntityType.Builder.of(Bearowl::new, MobCategory.CREATURE).sized(1.875F, 2.25F).clientTrackingRange(8).build("bearowl"));
