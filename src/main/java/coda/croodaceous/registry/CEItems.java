...
public class CEItems {
    ...
    // Spawn Eggs
    public static final RegistryObject<Item> ITEM_LIYOTE_SPAWN_EGG = ITEMS.register("liyote_spawn_egg", () -> new ForgeSpawnEggItem(CEEntities.LIYOTE, 0xd2761d, 0x595c92, new Item.Properties().tab(TAB)));
    public static final RegistryObject<Item> ITEM_BEAROWL_SPAWN_EGG = ITEMS.register("bearowl_spawn_egg", () -> new ForgeSpawnEggItem(CEEntities.BEAROWL, 0x463830, 0x8c867b, new Item.Properties().tab(TAB)));
    public static final RegistryObject<Item> ITEM_RAMU_SPAWN_EGG = ITEMS.register("ramu_spawn_egg", () -> new ForgeSpawnEggItem(CEEntities.RAMU, 0x222522, 0xb18444, new Item.Properties().tab(TAB)));
